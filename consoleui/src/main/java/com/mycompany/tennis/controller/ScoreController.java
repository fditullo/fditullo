...
public class ScoreController {
    ...
    public void afficheDetailScore(){
        ...
        System.out.println("Annee epreuve :"+score.getMatch().getEpreuve().getAnnee());

        System.out.println("Nom du tournoi :"+score.getMatch().getEpreuve().getTournoi().getNom());

        System.out.println("Type de l''epreuve "+score.getMatch().getEpreuve().getTypeEpreuve());
